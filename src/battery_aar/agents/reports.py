...
def _summary_row(report: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "surrogate_mape": _first_present(
            report.get("surrogate_search_validation_mape"),
            report.get("best_metrics", {}).get("mape"),
        ),
        "batch9_rmse": _first_present(report.get("locked_batch9_rmse"), final_metrics.get("rmse")),
        "batch9_mape": _first_present(report.get("locked_batch9_mape"), final_metrics.get("mape")),
